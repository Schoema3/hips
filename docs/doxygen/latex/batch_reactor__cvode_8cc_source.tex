\doxysection{batch\+Reactor\+\_\+cvode.\+cc}
\hypertarget{batch_reactor__cvode_8cc_source}{}\label{batch_reactor__cvode_8cc_source}\index{/Users/mbehrang/hips-\/publish-\/final/hips/src/batchReactor\_cvode.cc@{/Users/mbehrang/hips-\/publish-\/final/hips/src/batchReactor\_cvode.cc}}
...
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00073}00073\ \ \ \ \ \mbox{\hyperlink{classbatch_reactor_ae957b69e3e933ddcc85a809b8f06c8ad}{temperature}}\ =\ \mbox{\hyperlink{classbatch_reactor_a569251f4aa45e53dfd7584aa671a9771}{gas}}-\/>temperature();}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00074}00074\ }
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00075}00075\ \ \ \ \ std::vector<double>\ rr(\mbox{\hyperlink{classbatch_reactor_a25a411dda898478f3c8ff2a5351906e5}{nvar}});}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00076}00076\ \ \ \ \ \mbox{\hyperlink{classbatch_reactor_a44101d5defb4ba69474697744cbef158}{kin}}-\/>getNetProductionRates(\&rr[0]);}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00077}00077\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{size\_t}\ k\ =\ 0;\ k\ <\ \mbox{\hyperlink{classbatch_reactor_a569251f4aa45e53dfd7584aa671a9771}{gas}}-\/>nSpecies();\ k++)}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00078}00078\ \ \ \ \ \ \ \ \ dvarsdt[k]\ =\ rr[k]\ *\ \mbox{\hyperlink{classbatch_reactor_a569251f4aa45e53dfd7584aa671a9771}{gas}}-\/>molecularWeight(k)\ /\ \mbox{\hyperlink{classbatch_reactor_a38e600224710a61029e49eb91ab1480d}{rho}};}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00079}00079\ }
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00080}00080\ \ \ \ \ \textcolor{keywordflow}{return}\ 0;}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00081}00081\ \}}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00082}00082\ }
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00084}00084\ \textcolor{comment}{//\ CVODE\ interface;\ CVODE\ calls\ this\ function,\ which\ then\ calls\ user\_data's\ rhsf}}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00085}00085\ }
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00097}\mbox{\hyperlink{batch_reactor__cvode_8cc_a32482f0a6ee1883664a92263941f63b8}{00097}}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{batch_reactor__cvode_8cc_a32482f0a6ee1883664a92263941f63b8}{rhsf\_cvode}}(realtype\ t,\ N\_Vector\ varsCV,\ N\_Vector\ dvarsdtCV,\ \textcolor{keywordtype}{void}\ *user\_data)\ \{}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00098}00098\ }
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00099}00099\ \ \ \ \ \textcolor{comment}{//\ Cast\ user\_data\ pointer\ to\ batchReactor\_cvode\ pointer}}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00100}00100\ \ \ \ \ \mbox{\hyperlink{classbatch_reactor__cvode}{batchReactor\_cvode}}\ *bRxr\ =\ \textcolor{keyword}{static\_cast<}\mbox{\hyperlink{classbatch_reactor__cvode}{batchReactor\_cvode}}\ *\textcolor{keyword}{>}(user\_data);}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00101}00101\ }
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00102}00102\ \ \ \ \ \textcolor{comment}{//\ Get\ array\ pointers\ for\ variables\ and\ derivatives}}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00103}00103\ \ \ \ \ \textcolor{keywordtype}{double}\ *vars\ \ \ \ =\ N\_VGetArrayPointer(varsCV);}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00104}00104\ \ \ \ \ \textcolor{keywordtype}{double}\ *dvarsdt\ =\ N\_VGetArrayPointer(dvarsdtCV);}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00105}00105\ }
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00106}00106\ \ \ \ \ \textcolor{comment}{//\ Call\ rhsf\ method\ of\ batchReactor\_cvode\ instance}}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00107}00107\ \ \ \ \ \textcolor{keywordtype}{int}\ rv\ =\ bRxr-\/>\mbox{\hyperlink{classbatch_reactor__cvode_a22fd562f616891c39b82d8f320eba0f4}{rhsf}}(t,\ vars,\ dvarsdt);}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00108}00108\ }
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00109}00109\ \ \ \ \ \textcolor{keywordflow}{return}\ rv;}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00110}00110\ \}}
\DoxyCodeLine{\Hypertarget{batch_reactor__cvode_8cc_source_l00111}00111\ }
